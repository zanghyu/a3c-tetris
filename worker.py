...
from a3c import A3C
#from tetris_twoblocks import GameState
...
def run(args, server):
    gameState = GameState()
    trainer = A3C(gameState, args.task)
    ...
    saver = FastSaver(variables_to_save, max_to_keep = 20)
...
"""
    ...
    parser.add_argument('--log-dir', default="model_a3c", help='Log directory path')
